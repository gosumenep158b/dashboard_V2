...
function getPermintaanTST() {
  ...
  var dateIndex = _findTstHeader_(normalizedHeaders, ['tanggal', 'tgl', 'tanggal tst', 'jadwal', 'date']);
  if (dateIndex < 0) {
    throw new Error('Kolom tanggal pada sheet TST tidak ditemukan. Gunakan header Tanggal atau Tgl.');
  }
